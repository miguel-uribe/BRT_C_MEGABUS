...
const int fleet = 1000; // The maximum numbers of moving buses
const int factor = 1000; // the average passenger influx to the system, pass/hour
...
int origins[2] = {0, 2000}; // the origin of buses in the system
int ends[2] = {1980,3980}; // the end of buses in the system
